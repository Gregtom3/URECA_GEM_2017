...
{\bf\textsc{Test setup using GEM detectors for the sPHENIX TPC}\vspace{0.5em}} % Poster title
{\textsc{\{ Gregory Matousec, Benjamin Chase, Abigail Bishop \} \hspace{12pt} Stony Brook University ePHENIX}} % Author names and institution
